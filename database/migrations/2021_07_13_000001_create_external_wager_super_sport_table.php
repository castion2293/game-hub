...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('external_wager_super_sport', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE external_wager_wm_live COMMENT '外接遊戲 - SUPER體育注單資訊'");
    }
    ...
    {
        Schema::dropIfExists('external_wager_super_sport');
    }
};
